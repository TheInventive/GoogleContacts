...
namespace GmailContacts {
    ...
    public partial class ContactsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ContactsRow AddContactsRow(string FirstName, string LastName, string CompanyName, string JobTitle, string PhoneNumber) {
...
namespace GmailContacts.ContactsDBDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Contacts] ([FirstName], [LastName], [CompanyName], [JobTitle], [PhoneNumber]) VALUES (@FirstName, @LastName, @CompanyName, @JobTitle, @PhoneNumber);
SELECT ContactId, FirstName, LastName, CompanyName, JobTitle, PhoneNumber FROM Contacts WHERE (ContactId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contacts] SET [FirstName] = @FirstName, [LastName] = @LastName, [CompanyName] = @CompanyName, [JobTitle] = @JobTitle, [PhoneNumber] = @PhoneNumber WHERE (([ContactId] = @Original_ContactId));
SELECT ContactId, FirstName, LastName, CompanyName, JobTitle, PhoneNumber FROM Contacts WHERE (ContactId = @ContactId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GmailContacts.Properties.Settings.Default.ContactsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactId, FirstName, LastName, CompanyName, JobTitle, PhoneNumber FROM db" +
                "o.Contacts";
        ...
        public virtual int Fill(ContactsDBDataSet.ContactsDataTable dataTable) {
        ...
        public virtual ContactsDBDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactsDBDataSet.ContactsDataTable dataTable = new ContactsDBDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactsDBDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Insert(string FirstName, string LastName, string CompanyName, string JobTitle, string PhoneNumber) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string CompanyName, string JobTitle, string PhoneNumber, int Original_ContactId, int ContactId) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string CompanyName, string JobTitle, string PhoneNumber, int Original_ContactId) {
            return this.Update(FirstName, LastName, CompanyName, JobTitle, PhoneNumber, Original_ContactId, Original_ContactId);
        }
    }
